...
let Ozan   = document.querySelector('.fb_Ozan');
...
const animeren = () => {
    ...
    setTimeout( () => {Ozan.classList.remove('fb--uit')}, 300);
...
//banner linken//
const gaNaarPagina = () => window.open('http://24663.hosts.ma-cloud.nl/bewijzenmap/', '_blank');
